    ...
    <section className="bg-white dark:bg-[#101e2e] py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-2">
          <div>
            <h2 className="mb-6 font-mulish text-3xl font-extrabold text-[#101b25] dark:text-white sm:text-4xl">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              {aboutStats.map((stat) => (
                <div key={stat.num}>
                  <p className="font-mulish text-4xl font-extrabold leading-none text-primary dark:text-[#7fb3df] sm:text-5xl">
                    {stat.num}
                  </p>
                  <p className="mt-2 font-open-sans text-sm leading-relaxed text-[#5b6774] dark:text-[#9aa5b0]">
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          <div className="font-open-sans text-lg leading-relaxed text-[#5b6774] dark:text-[#9aa5b0]">
            <p>
